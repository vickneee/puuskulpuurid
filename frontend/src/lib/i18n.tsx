...
const itemTranslations: Record<Lang, ItemDict> = {
    et: {
        ...
        11: {title: "Otepää künkad", description: "Otepää künkad."},
        12: {title: "Voodi", description: "Öökullidega puidust voodi."},
        13: {title: "Öökullid", description: "Ökullid."},
        14: {title: "Merineitsi", description: "Merineitsi."},
        15: {title: "Sarikas", description: "Sarikas."},
        16: {title: "Voodi", description: "Voodi karudega."},
    ...
    en: {
        ...
        11: {title: "Otepää Hills", description: "Otepää hills."},
        12: {title: "Bed", description: "Bed with owls."},
        13: {title: "Owls", description: "Owls."},
        14: {title: "Merimaid", description: "Merimaid."},
        15: {title: "Rafter", description: "Rafter."},
        16: {title: "Bed", description: "Bed with bears."},
