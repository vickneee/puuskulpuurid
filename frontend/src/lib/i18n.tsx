...
const translations: Translations = {
  et: {
    ...
    "about.p1": "Üle 15-aastase kogemusega algab iga ese hoolikalt valitud puidust ja sügavast lugupidamisest looduse vastu. Töötades väikeses töökojas, ühendan traditsioonilised puutööoskused kaasaegse disainiga, et luua nii kasulikke kui ka kauneid esemeid.",
    "about.p2": "Iga teos jutustab oma loo — alates valitud puuliigist kuni käsitsi peale kantud viimistluseni. Ükski ese ei ole täpselt teise sarnane, sest loodus ei korda end kunagi.",
    "about.imgAlt": "Meister LOODUSES",
    // Contact
    "contact.kicker": "Võta ühendust",
    "contact.title": "Loome koos",
    "contact.subtitle": "Kas Teil on idee tellimustööks? Kirjutage julgelt ja toome Teie nägemuse puidust ellu.",
    "contact.email": "E-post",
    "contact.phone": "Telefon",
    "contact.workshop": "Töökoda",
    "contact.workshop.value": "Tallinn, Eesti",
